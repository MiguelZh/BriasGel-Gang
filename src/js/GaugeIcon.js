...
var GaugeIcon = function (game, x, y, sprite, spriteempty, height, width, backgroundh, backgroundw, player) {
    this.player=player;
    this.sprite = sprite;
    ...
    this.background = new Interface(game, x, y, this.backgroundsprite, backgroundh, backgroundw);
...
GaugeIcon.prototype.Update = function (stat) {
    ...
    this.background.height = stat / 100 * this.height;
